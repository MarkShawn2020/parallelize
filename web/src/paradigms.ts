...
export const RADAR_AXES = ["准确率", "成本", "速度"] as const;
...
/** 0-100 per axis, outward is better (cheaper, faster); cost and speed are relative to the cheapest and fastest rung. */
export function radarValues(p: Paradigm): number[] {
  return [accuracyOf(p), (minCost / p.costUsd) * 100, (minWall / p.wallS) * 100];
}
